...
- Never idle-wait for a background agent or command - see `delegation.md` for the rule against `sleep`/polling while a delegate or background command is running.
